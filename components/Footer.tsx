...
const Footer: React.FC = () => {
  ...
  const socials = [
    { name: 'Facebook', icon: 'fab fa-facebook-f', href: 'https://www.facebook.com/bdasrafulsm' },
    { name: 'Instagram', icon: 'fab fa-instagram', href: 'https://www.instagram.com/bdasrafulsm/' },
  ];
  return (
    <>
      ...
      <footer className="footer-bg pt-24 pb-8 px-8 md:px-20 border-t border-white/5 relative z-10 bg-[#05010a] text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          ...
          <div className="md:col-span-5">
            ...
            <a 
              href="mailto:bdasrafulsm@gmail.com" 
          ...
          <div className="md:col-span-4">
            <div className="mb-10">
              ...
              <div className="flex items-center gap-4 text-gray-400 text-lg group">
                ...
                <a href="mailto:bdasrafulsm@gmail.com" className="hover:text-white transition-colors">bdasrafulsm@gmail.com</a>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center gap-4 text-gray-400 text-lg group">
                ...
                <a href="https://wa.me/8801516557095" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">+8801516557095</a>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8 text-[9px] font-black uppercase tracking-[0.2em] text-gray-700">
            ...
            <a href="#" className="hover:text-cyan-300 transition-all">Terms of Service</a>
          </div>
        </div>
