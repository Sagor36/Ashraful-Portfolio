...
const TimelineItem: React.FC<TimelineItemProps> = ({ year, title, subtitle, desc }) => (
  <div className="relative pl-10 border-l-2 border-cyan-500/20 pb-12 last:pb-0 group">
    <div className="absolute left-[-9px] top-0 w-4 h-4 rounded-full bg-transparent border-2 border-cyan-300 shadow-[0_0_15px_rgba(251,191,36,0.5)] group-hover:scale-125 transition-transform duration-300"></div>
    <div className="glass p-8 rounded-2xl hover:translate-x-3 transition-all duration-500 neon-border bg-gradient-to-br from-white/[0.03] to-transparent">
      <span className="inline-block px-3 py-1 rounded-md bg-cyan-300/10 text-cyan-300 text-[10px] font-black uppercase tracking-widest mb-4">
        {year}
      </span>
      <h4 className="text-2xl font-black text-white mb-1">{title}</h4>
      <p className="text-cyan-500/80 font-bold text-sm mb-4">{subtitle}</p>
...
const Resume: React.FC = () => {
  ...
  const experience = [
    { 
      ...
      company: 'Independent Digital Marketing Professional',
      desc: 'I have been driving business growth through expert YouTube SEO, Video Promotion, Google/Facebook Ads, and Website SEO, with a focus on practical strategies that improve visibility and ROI. I specialize in delivering high-impact digital strategies that maximize brand visibility and ROI.'
    },
    { 
      year: '2021 - 2022', 
  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      <div className="text-center mb-20">
        <h2 className="text-cyan-300 font-black uppercase tracking-[0.4em] text-xs mb-4"></h2>
        <h3 className="text-4xl md:text-5xl font-extrabold underline decoration-cyan-500 decoration-2 underline-offset-[16px]">
          My Resume
        </h3>
      </div>
