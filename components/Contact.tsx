...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setStatus({ type: 'success', message: 'Message sent! Ashraful Islam will contact you shortly.' });
  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-3 gap-10 mb-20">
        {[
          { icon: '📱', title: 'WhatsApp / Phone', value: '+8801516557095' },
          { icon: '📧', title: 'Email', value: 'bdasrafulsm@gmail.com' },
          { icon: '◎', title: 'Instagram', value: '@bdasrafulsm' }
        ].map((item, i) => (
      ...
      <div className="max-w-4xl mx-auto glass p-8 md:p-14 rounded-[3rem] neon-border">
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <input 
                ...
                className="w-full bg-white/5 border-b border-white/10 p-4 outline-none focus:border-cyan-500 transition-colors text-white placeholder:text-gray-600 font-medium"
              />
            </div>
            <div className="space-y-2">
              <input 
          ...
          <textarea 
            ...
            onChange={handleChange}
            className="w-full bg-white/5 border-b border-white/10 p-4 outline-none focus:border-cyan-500 transition-colors text-white placeholder:text-gray-600 font-medium resize-none"
          ></textarea>
          ...
          <div className="text-center">
            <button 
              ...
              className="bg-white text-black px-16 py-5 rounded-full font-black uppercase tracking-[0.3em] text-xs hover:bg-cyan-300 transition-all transform hover:scale-105 active:scale-95 disabled:opacity-50 shadow-2xl"
            >
